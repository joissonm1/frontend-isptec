  ...
  return (
    <>
      <main className="overflow-hidden">
        <div
          aria-hidden
          className="pointer-events-none isolate absolute inset-0 z-2 hidden opacity-50 contain-strict lg:block"
        >
          <div className="absolute left-0 top-0 h-320 w-140 -translate-y-87.5 -rotate-45 rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,color-mix(in_srgb,var(--color-interactive-2)_16%,transparent)_0,hsla(0,0%,55%,.02)_50%,transparent_80%)]" />
          <div className="absolute left-0 top-0 h-320 w-56 -rotate-45 bg-[radial-gradient(50%_50%_at_50%_50%,color-mix(in_srgb,var(--color-text)_10%,transparent)_0,color-mix(in_srgb,var(--color-text)_4%,transparent)_80%,transparent_100%)] [translate:5%_-50%]" />
          <div className="absolute left-0 top-0 h-320 w-56 -translate-y-87.5 -rotate-45 bg-[radial-gradient(50%_50%_at_50%_50%,color-mix(in_srgb,var(--color-interactive-2)_10%,transparent)_0,color-mix(in_srgb,var(--color-text)_3%,transparent)_80%,transparent_100%)]" />
        </div>
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  <Link
                    href="#link"
                    className="group mx-auto flex w-fit items-center gap-4 rounded-full border border-border/60 bg-muted/50 p-1 pl-4 shadow-md shadow-black/5 transition-all duration-300 hover:bg-background"
                  >
                    <span className="text-sm text-foreground">Novas oportunidades em destaque</span>
                    <span className="block h-4 w-0.5 border-l border-border/60 bg-white/30" />
                  ...
                  <h1 className="mx-auto mt-8 max-w-4xl text-balance text-5xl font-black md:text-6xl lg:mt-16 xl:text-[5.25rem]">
                    UniBridge — liga talento a oportunidades reais
                  </h1>
                  <p className="mx-auto mt-6 max-w-2xl text-balance text-lg text-muted">
                    Componentes modernos e altamente personalizáveis para construir experiências que refletem a tua identidade.
                  </p>
                </AnimatedGroup>
                ...
                >
                  <div key={1} className="rounded-[14px] border border-border/60 bg-foreground/10 p-0.5">
                  ...
                  <Button key={2} asChild size="lg" variant="ghost" className="h-10.5 rounded-xl px-6">
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                <div aria-hidden className="absolute inset-0 z-10 bg-linear-to-b from-transparent from-35% to-background" />
          ...
          <div className="group relative m-auto max-w-5xl px-6">
            <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
              <Link href="/" className="block text-sm duration-150 hover:opacity-75">
                <span> Conhece os nossos parceiros</span>
                <ChevronRight className="ml-1 inline-block size-3" />
              </Link>
            </div>
            <div className="mx-auto mt-12 grid max-w-2xl grid-cols-2 gap-x-10 gap-y-6 transition-all duration-500 group-hover:opacity-60 sm:grid-cols-4 sm:gap-x-14 sm:gap-y-10">
              {[
                ...
                "https://images.unsplash.com/photo-1553877522-43269d4ea984?auto=format&fit=crop&w=256&q=80",
              ].map((src, idx) => (
                <div key={idx} className="flex">
                  <img className="mx-auto h-10 w-16 rounded-xl object-cover" src={src} alt="Parceiro" />
                </div>
              ))}
            </div>
          </div>
